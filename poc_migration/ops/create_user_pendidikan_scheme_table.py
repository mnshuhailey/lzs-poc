...
@op(ins={"after_create_user_bank": In(Nothing)}, required_resource_keys={"lzs_poc_migration"})
def create_user_pendidikan_scheme_table(context):
    base_dir = os.path.dirname(os.path.realpath(__file__))
    sql_file_path = os.path.join(base_dir, '../sql/create_user_pendidikan_scheme_table.sql')
